...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["quotes-quotes-module"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppPagesQuotesQuotesPageHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<!--Code from 23/4 class-->\n<ion-header>\n  <ion-toolbar color=\"primary\">\n    <ion-title>Quotes</ion-title>\n  </ion-toolbar>\n</ion-header>\n<ion-content>\n\n\t<ion-searchbar placeholder=\"Search Quotes by Author\" (ionChange)=\"onSearchChange($event)\"></ion-searchbar>\n\n    <ion-list>\n        <ion-item button detail lines=\"inset\" *ngFor=\"let quote of quotes | async\" (click)=\"openDetails(quote)\">\n        {{ quote.quote }}\n        </ion-item>\n    </ion-list>\n</ion-content>\n";
    /***/
  },
  ...
  function srcAppPagesQuotesQuotesPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    "./src/app/services/breakingbad.service.ts"); // main logic for 'quotes'
    ...
    var QuotesPage = /*#__PURE__*/function () {
      ...
      _createClass(QuotesPage, [{
        ...
        value: function onSearchChange(e) {
          ...
          var authorNameQuery = e.detail.value;
          ...
          this.quotes.subscribe(function (data) {
            _this.quotes = _this.api.findBBQuote(authorNameQuery);
          }, function (err) {
            _this.loadBBQuotes();
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _services_breakingbad_service__WEBPACK_IMPORTED_MODULE_3__["BreakingBadService"]])], QuotesPage);
    /***/
  }
}]);
