...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  /***/
  function srcAppServicesBreakingbadServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "BreakingBadService", function () {
      return BreakingBadService;
    });
    /* harmony import */
    ...
    /*! rxjs/operators */
    "./node_modules/rxjs/_esm2015/operators/index.js"); // Initial code from 14/4 class
    // 25/4 - Added getters for characters, quotes and deaths 
    // API doc @ https://breakingbadapi.com/Documentation


    var BreakingBadService = /*#__PURE__*/function () {
      function BreakingBadService(http) {
        _classCallCheck(this, BreakingBadService);
      ...
      _createClass(BreakingBadService, [{
        key: "getEpisodes",
        ...
        value: function getCharacters() {
          ...
          return this.http.get("../assets/characters.json?offset=".concat(offset, "&limit=25")); //   .pipe(
          //       map(result => {
        ...
        value: function getCharacter(id) {
          var character = this.http.get("".concat(this.baseUrl, "/characters/").concat(id));
          return character;
        }
      }, {
        key: "getCharacterByName",
        value: function getCharacterByName(charName) {
          return this.http.get("".concat(this.baseUrl, "/characters?name=").concat(charName));
        }
      }, {
        key: "getQuotes",
        ...
        value: function getQuoteByAuthor(charName) {
          return this.http.get("".concat(this.baseUrl, "/quote?author=").concat(charName));
        }
      }, {
        key: "getDeaths",
        ...
        value: function getDeath(id) {
          ...
          return this.getDeaths().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) {// doSomething 
          }));
        }
      }, {
        key: "getDeathCount",
        value: function getDeathCount(killer) {
          return this.http.get("".concat(this.baseUrl, "/death-count?name=").concat(killer));
        } // OTHER METHODS
        // @TODO
        ...
        key: "findBBCharacter",
        value: function findBBCharacter(charNameQuery) {
          console.log('search: ', charNameQuery);
          return this.getCharacterByName(charNameQuery);
        }
      }, {
        key: "findBBQuote",
        value: function findBBQuote(charNameQuery) {
          console.log('search: ', charNameQuery);
          return this.getQuoteByAuthor(charNameQuery);
        }
      }, {
        key: "findBBKills",
        value: function findBBKills(charNameQuery) {
          console.log('search: ', charNameQuery);
    ...
    BreakingBadService.ctorParameters = function () {
      return [{
        type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]
      }];
    };

    BreakingBadService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]])], BreakingBadService);
    /***/
  }
}]);
