...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["deaths-deaths-module"], {
  ...
  function srcAppPagesDeathsDeathsPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var DeathsPage = /*#__PURE__*/function () {
      ...
      _createClass(DeathsPage, [{
        ...
        value: function onSearchChange(e) {
          ...
          var killerNameQuery = e.detail.value;
          ...
          this.deaths.subscribe(function (data) {
            _this.deaths = _this.api.findBBQuote(killerNameQuery);
          }, function (err) {
            _this.loadBBDeaths();
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _services_breakingbad_service__WEBPACK_IMPORTED_MODULE_3__["BreakingBadService"]])], DeathsPage);
    /***/
  }
}]);
